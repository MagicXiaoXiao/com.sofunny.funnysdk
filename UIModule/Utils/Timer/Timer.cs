...
namespace SoFunny.FunnySDK.UIModule
{
    public class Timer
    {
        ...
        /// </summary>
        internal bool usesRealTime { get; private set; }
        ...
        internal static void Cancel(Timer timer)
        {
            if (timer != null)
            {
                timer.Cancel();
        ...
        internal static void Pause(Timer timer)
        {
            if (timer != null)
            {
                timer.Pause();
        ...
        internal static void Resume(Timer timer)
        {
            if (timer != null)
            {
                timer.Resume();
        ...
        internal static void CancelAllRegisteredTimers()
        {
            if (Timer._manager != null)
            {
        ...
        internal static void PauseAllRegisteredTimers()
        {
            if (Timer._manager != null)
            {
        ...
        internal static void ResumeAllRegisteredTimers()
        {
            if (Timer._manager != null)
            {
        ...
        internal float GetTimeRemaining()
        {
        ...
        internal float GetRatioComplete()
        {
        ...
        internal float GetRatioRemaining()
        {
