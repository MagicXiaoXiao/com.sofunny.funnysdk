...
#ifndef FUNNYSDK_SWIFT_H
#define FUNNYSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FunnySDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8FunnySDK11LoginButton")
@interface LoginButton : UIButton
/// Creates a predefined FUNNY Login button.
